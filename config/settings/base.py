...
)  # (web_interactive/config/settings/base.py - 3 = web_interactive/)
APPS_DIR = ROOT_DIR.path("web_interactive")
...
LOCAL_APPS = [
    "web_interactive.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "web_interactive.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "web_interactive.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "web_interactive.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "web_interactive.users.adapters.SocialAccountAdapter"
...
GRAPHENE = {
    "SCHEMA": "web_interactive.graphql.schema.schema",
